...
ALTER TABLE `glowingoctoguacamole`.`property_value` DROP FOREIGN KEY `property_value_ibfk_1`;
...
ALTER TABLE `glowingoctoguacamole`.`molecule_property` DROP FOREIGN KEY `molecule_property_ibfk_2`;
